...
class GetClassViewController: UIViewController {
    
    var cookieData:String = ""
    
    init(cookie: String,nibName nibNameOrNil: String?, bundle nibBundleOrNil: NSBundle?) {
